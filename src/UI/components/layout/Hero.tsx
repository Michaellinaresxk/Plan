  ...
  return (
    <div className='relative min-h-screen w-full overflow-hidden font-[family-name:var(--font-outfit)]'>
      ...
      <div className='absolute inset-0 z-0'>
        ...
        <div className='absolute inset-0 bg-gradient-to-br from-black/50 via-black/60 to-black/90 z-10'></div>
                ...
                <Link href='/custom-package'>
                  ...
                  >
                    <span className='relative z-10 flex items-center justify-center'>
                      ...
                      <ChevronRight className='ml-3 transition-transform group-hover:translate-x-2' size={22} />
                    </span>
          ...
          >
            <Link href='#packages'>
              <div className='w-12 h-12 border-2 border-white/30 rounded-full flex items-center justify-center hover:border-amber-400/60 transition-all duration-300 group'>
                <ArrowDownCircle size={24} className='text-white/60 group-hover:text-amber-400/80 transition-colors duration-300' />
              </div>
            </Link>
          </motion.div>
        </motion.div>
