...
/**
 * Componente especializado para mostrar detalles de servicios de chef privado
 */
const ChefDetails: React.FC<ChefDetailsProps> = ({ service, serviceData }) => {
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4'>
            {Object.entries(cuisineOptions).map(([key, cuisine]) => (
              ...
              >
                ...
                <div className='absolute inset-0 bg-gradient-to-br from-blue-500/5 to-blue-500/20 opacity-0 group-hover:opacity-100 transition-opacity'></div>
            ...
            {Object.entries(mealOptions).map(([key, meal]) => (
              ...
              >
                <div className='flex items-center'>
                  <Utensils className='h-5 w-5 text-blue-600 mr-3' />
                  <div>
