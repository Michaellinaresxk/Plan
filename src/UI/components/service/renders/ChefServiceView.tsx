        ...
        {activeTab === 'overview' && (
          ...
          >
            ...
            <div className='bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100'>
              <div className='p-8'>
                <h2
                  className={`text-2xl font-bold mb-8 text-${primaryColor}-800 flex items-center`}
                >
                  <Menu className='mr-2' />
                ...
                <div className='space-y-10'>
                  {sampleMenuItems.map((category, idx) => (
                    <div key={idx}>
                      <h3
                        className={`text-xl font-medium mb-6 pb-2 border-b border-${primaryColor}-200`}
                      >
                        {category.category}
                      </h3>
                        ...
                        {category.items.map((item, itemIdx) => (
                          <div
                            ...
                            className={`p-4 rounded-lg ${
                              item.isSignature
                                ? `bg-${primaryColor}-50 border border-${primaryColor}-100`
                                : 'bg-gray-50'
                            }`}
                          >
                            <div className='flex justify-between'>
                              <h4 className='font-semibold text-gray-900'>
                                ...
                                {item.isSignature && (
                                  <span
                                    className={`ml-2 text-xs px-2 py-0.5 rounded-full bg-${primaryColor}-100 text-${primaryColor}-800`}
                                  >
                                    Chef's Signature
                                  </span>
                                )}
                ...
                <div className='mt-10 text-center'>
                  <p className='text-gray-500 italic mb-6'>
                    These are sample menu items. Our chefs will work with you to
                    create a personalized menu based on your preferences and
                    dietary requirements.
                  </p>
                  <button
                    onClick={handleOpenBookingModal}
                    className={`px-6 py-3 bg-${primaryColor}-100 text-${primaryColor}-700 rounded-lg hover:bg-${primaryColor}-200 transition-colors inline-flex items-center gap-2`}
                  >
                    <span>Discuss Your Menu</span>
